...
def flash_attn_with_kvcache(
    ...
    # Pass by keyword: the backing kernel's positional order is not stable
    # (e.g. sgl-kernel inserted `only_qv` before `sm_margin`), and a silent
    # shift there turns `return_softmax_lse` into a no-op.
